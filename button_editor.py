		...
		for col in range(num_repeat):
			if world_data[row][col] > 0:
				if world_data[row][col] == 1:
					pygame.draw.rect(screen,orange,pygame.rect(col * tile_size, row * screen_height//tile_size, tile_size, tile_size) )
					pygame.display.flip()
					#tile1
					# img = pygame.transform.scale(tile1_img, (tile_size,tile_size))
					# screen.blit(img, (col * tile_size, row * screen_height//tile_size))
				if world_data[row][col] == 2:
					pygame.draw.rect(screen,white1,pygame.rect(col * tile_size, row * screen_height//tile_size, tile_size, tile_size) )
					pygame.display.flip()
					#tile2
					# img = pygame.transform.scale(tile2_img, (tile_size, tile_size))
					# screen.blit(img, (col * tile_size, row * screen_height//tile_size))
				if world_data[row][col] == 3:
					pygame.draw.rect(screen,shadow,pygame.rect(col * tile_size, row * screen_height//tile_size, tile_size, tile_size) )
					pygame.display.flip()
					#tile3
