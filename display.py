...
class Display:
    def __init__(self,scr) -> None:
        ...
        # surface = pygame.Surface(self.BackgroundImg.get_size())
        # pil_image = self.BackgroundImg.frombytes('RGBA', surface.get_size(), pygame.image.tostring(surface, 'RGBA'))
        # blur_radius = 10
        # pil_image_blur = pil_image.filter(ImageFilter.GaussianBlur(radius=blur_radius))
        # self.blurred_surface = pygame.image.fromstring(pil_image_blur.tobytes(), pil_image_blur.size, pil_image_blur.mode)
