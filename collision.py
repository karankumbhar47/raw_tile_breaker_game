...
class Collision:
    ...
    def makeRect(self):
        ...
        self.objectPoints = [
            [self.objectRect.topleft, self.objectRect.midtop,
                self.objectRect.topright],
            [self.objectRect.midleft, self.objectRect.center,
                self.objectRect.midright],
            [self.objectRect.bottomleft, self.objectRect.midbottom,
                self.objectRect.bottomright]
        ]
        ...
        self.surfacePoints = [
            [self.surfaceRect.topleft, self.surfaceRect.midtop,
                self.surfaceRect.topright],
            [self.surfaceRect.midleft, self.surfaceRect.center,
                self.surfaceRect.midright],
            [self.surfaceRect.bottomleft, self.surfaceRect.midbottom,
                self.surfaceRect.bottomright]
        ]
